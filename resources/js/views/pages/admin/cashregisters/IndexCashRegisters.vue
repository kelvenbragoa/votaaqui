...
const getData = async (page = 1) => {
    axios
        .get(`/api/cashregister?page=${page}`, {
            params: {
    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Registros Caixa</div>
                    <DataTable
                    ...
                    <template #header>
                        <div class="flex justify-between">
                            <router-link to="/admin/dailydashboard">
                                <Button label="Voltar" class="mr-2 mb-2">Painel Caixa Diário<i class="pi pi-activity"></i></Button>
                            </router-link>
                            <IconField>
                                <InputIcon>
                    ...
                    <template #body="{ data }">
                        <!-- <router-link class="m-3" :to="'/admin/users/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>   -->
