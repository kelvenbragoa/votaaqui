...
const getData = async (page = 1) => {
    axios
        .get(`/api/centerstocks?page=${page}`, {
            params: {
                ...
                <div class="font-semibold text-xl">Centro de Stock</div>
                    ...
                    <template #header>
                        <div class="flex justify-between">
                            <router-link to="/admin/centerstocks/create">
                    ...
                    <Column header="Capacidade Máxima" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.maximum_capacity }}
                        </template>
                    </Column>
                    <Column header="Stock Principal" style="min-width: 12rem">
                        <template #body="{ data }">
                            <Tag :value="getSeverityName(data.is_principal_stock)" :severity="getSeverity(data.is_principal_stock)" /> 
                        </template>
                    </Column>
                    ...
                    <template #body="{ data }">
                        <!-- <router-link class="m-3" :to="'/admin/centerstocks/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>   -->
                        <router-link class="m-3" :to="'/admin/centerstocks/' + data.id"><i class="pi pi-eye"></i></router-link>
