        ...
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <form @submit="onSubmit">
                    ...
                    <Column header="Quantidade Esperado" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.quantity }}
                        </template>
                    </Column>
                    <Column header="Contado" dataType="number" style="min-width: 10rem">
                        <template #body="{ data }">
