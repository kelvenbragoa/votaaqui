...
const getData = async (page = 1) => {
    axios
        .get(`/api/paymentmethods/${router.currentRoute.value.params.id}`, {
            params: {
    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Método de Pagamento</div>
                   <p><strong>Método de Pagamento:</strong> {{ retriviedData.name }}</p>

                   <p><strong>Estado:</strong> <Tag :value="retriviedData.status.name" :severity="getSeverity(retriviedData.status_id)" /></p>
