...
const getData = async (page = 1) => {
    axios
        .get(`/api/payments/${router.currentRoute.value.params.id}`, {
            params: {
    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Pagamento</div>
                   <p><strong>ID:</strong> #{{ retriviedData.id }}</p>
                   <p><strong>ID da Encomenda:</strong> #{{ retriviedData.order_id }}</p>
                   <p><strong>Metodo de Pagamento:</strong> {{ retriviedData.method.name }}</p>
                   <p><strong>Valor:</strong> MZN{{ retriviedData.amount }}</p>
