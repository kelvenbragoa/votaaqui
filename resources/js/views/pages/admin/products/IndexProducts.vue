        ...
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Produtos</div>
                    ...
                    <template #body="{ data }">
                        <router-link class="m-3" :to="'/admin/products/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>  <router-link class="m-3" :to="'/admin/products/' + data.id"><i class="pi pi-eye"></i></router-link>
