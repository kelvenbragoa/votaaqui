                ...
                <div class="font-semibold text-xl">SubCategorias</div>
                    ...
                    <template #header>
                        <div class="flex justify-between">
                            <router-link to="/admin/reservations/create">
                    ...
                    <template #body="{ data }">
                        <router-link class="m-3" :to="'/admin/reservations/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>  <router-link class="m-3" :to="'/admin/reservations/' + data.id"><i class="pi pi-eye"></i></router-link>
