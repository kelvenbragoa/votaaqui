...
const schema = yup.object({
    ...
    website: yup.string().required().trim().label('website'),
            ...
            <div class="card flex flex-col gap-4">
                ...
                <form @submit="onSubmit">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <InputText v-model="city" id="city" placeholder="Cidade" :class="{ 'p-invalid': errors.city }" type="text" />
                        <small id="city-help" class="p-error">{{ errors.city }}</small>

                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="country">País</label>
                        <InputText v-model="country" id="country" placeholder="Endereço" :class="{ 'p-invalid': errors.country }" type="text" />
                        <small id="country-help" class="p-error">{{ errors.country }}</small>

                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="email">Email</label>
                        <InputText v-model="email" id="email" placeholder="Email" :class="{ 'p-invalid': errors.email }" type="text" />
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <InputText v-model="website" id="website" placeholder="Website" :class="{ 'p-invalid': errors.website }" type="text" />
