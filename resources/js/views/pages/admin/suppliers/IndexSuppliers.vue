        ...
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Fornecedores</div>
                    ...
                    <Column header="Endereço" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.address }}
                        </template>
                    </Column>
                    ...
                    <Column header="País" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.country }}
                        </template>
                    </Column>
                    ...
                    <template #body="{ data }">
                        <!-- <router-link class="m-3" :to="'/admin/suppliers/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>   -->
                        <router-link class="m-3" :to="'/admin/suppliers/' + data.id"><i class="pi pi-eye"></i></router-link>
