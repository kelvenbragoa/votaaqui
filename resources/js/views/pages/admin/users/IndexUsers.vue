        ...
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Usuários</div>
                    ...
                    <Column header="Nivel" style="min-width: 12rem">
                        <template #body="{ data }">
                            <Tag :value="data.role.name" :severity="getSeverity(1)" />
                        </template>
                    </Column>
                    ...
                    <template #body="{ data }">
                        <router-link class="m-3" :to="'/admin/users/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>  <router-link class="m-3" :to="'/admin/users/' + data.id"><i class="pi pi-eye"></i></router-link>
