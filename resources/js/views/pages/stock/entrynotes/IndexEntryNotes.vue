    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Notas de Entrada de Stock</div>
                    <DataTable
                    ...
                    <template #body="{ data }">
                        <!-- <router-link class="m-3" :to="'/stock/entrynotes/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>   -->
                        <router-link class="m-3" :to="'/stock/entrynotes/' + data.id"><i class="pi pi-eye"></i></router-link>
