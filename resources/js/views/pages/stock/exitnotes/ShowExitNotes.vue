...
const getData = async (page = 1) => {
    axios
        .get(`/api/exitnotes/${router.currentRoute.value.params.id}?page=${page}`, {
            params: {
    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Saída de Stock</div>
                   ...
                   <DataTable
                    ...
                    <Column header="Quantidade Retirada" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.quantity }}
                        </template>
                    </Column>
