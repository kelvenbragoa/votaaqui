    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            <div class="card flex flex-col gap-4">
                <div class="font-semibold text-xl">Inventário de Stock</div>
                    <DataTable
                    ...
                    <template #header>
                        <div class="flex justify-between">
                            <router-link to="/stock/inventories/create">
                    ...
                    <Column header="Produtos Inventariados" style="min-width: 12rem">
                        <template #body="{ data }">
                    ...
                    <template #body="{ data }">
                        <!-- <router-link class="m-3" :to="'/stock/inventories/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>   -->
                        <router-link class="m-3" :to="'/stock/inventories/' + data.id"><i class="pi pi-eye"></i></router-link>
