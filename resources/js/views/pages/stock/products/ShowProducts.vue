...
const getData = async (page = 1) => {
    axios
        .get(`/api/products/${router.currentRoute.value.params.id}`, {
            params: {
        ...
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Produtos</div>
                   <p><strong>Produto:</strong> {{ retriviedData.name }}</p>
                   <p><strong>Categoria:</strong> {{ retriviedData.category.name }}</p>
                   <p><strong>SubCategoria:</strong> {{ retriviedData.subcategory.name }}</p>
                   <p><strong>Departamento:</strong> {{ retriviedData.category.department.name }}</p>
