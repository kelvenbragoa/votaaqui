...
const getData = async (page = 1) => {
    axios
        .get(`/api/suppliers/${router.currentRoute.value.params.id}`, {
            params: {
        ...
        <div class="w-full">
            ...
            <div class="card flex flex-col gap-4">
                ...
                <div class="font-semibold text-xl">Categoria</div>
                   ...
                   <p><strong>País:</strong> {{ retriviedData.country }}</p>
                   <p><strong>Email:</strong> {{ retriviedData.name }}</p>
                   <p><strong>NUIT:</strong> {{ retriviedData.nuit }}</p>
