  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <!-- <img src="{{asset('votaaqui/assets/img/logo.webp')}}" alt=""> -->
      ...
      <div class="container">
        ...
        <div class="speakers-list">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 speaker-entry">
              <div class="speaker-profile">
                <div class="speaker-meta">
                  <div class="speaker-photo">
                    <img src="{{asset('votaaqui/assets/img/events/speaker-4.webp')}}" alt="Speaker" class="img-fluid">
                  </div>
                ...
                <div class="speaker-details">
                  ...
                  <p class="speaker-summary">Cantor e compositor.</p>
                  <div class="speaker-actions">
                    <a href="votar_participante.html" class="profile-btn">Votar neste participante</a>
