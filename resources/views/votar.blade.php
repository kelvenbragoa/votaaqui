  ...
  <main class="main">
    ...
    <div class="page-title dark-background" style="background-image: url(assets/img/events/showcase-9.webp);">
      <div class="container position-relative">
        ...
        <p>escolha o metodo do teu voto.</p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html">Home</a></li>
            <li class="current">Teu voto</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
          ...
          <div class="col-lg-8">
            ...
            <div class="ticket-form-wrapper">
              ...
              <div class="ticket-types">
                <h4>Selecione o metodo de voto</h4>
                ...
                <div class="ticket-option">
                  ...
                  <label for="student" class="ticket-label">
                    ...
                    <div class="ticket-price">
                      <span class="current-price">10MT</span>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <form action="forms/buy-tickets.php" method="post" class="php-email-form ticket-form">
                ...
                <div class="pricing-summary">
                  ...
                  <div class="summary-row">
                    <span>Voto em:</span>
                    <span class="ticket-name-display">Joao Mario</span>
                  </div>
                  <div class="summary-row">
                  ...
                  <div class="summary-row">
                    ...
                    <span class="unit-price-display">10MT</span>
                  </div>
                  <div class="summary-row total">
                    <span>Total:</span>
                    <span class="total-price">10Mt</span>
                  </div>
                  <div class="tax-note">*taxas inclusas</div>
                </div>
